...
class NMPCLeadLagNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("NMPC 动力学节点已启动：lead_lag已关闭，等待接收全局路径...")
    ...
    def control_loop(self):
        ...
        for i in range(self.Np + 1):
            ...
            if self.use_lead_lag:
                ...
                v_ref_ll = float(np.clip(v_ref,self.v_min, self.v_max))
            ...
            if i < self.Np:
                ...
                if self.use_lead_lag:
                    ...
                    v_next_ll = float(np.clip(v_next, self.v_min, self.v_max))
