...
class NMPCLeadLagNode(Node):
    ...
    def control_loop(self):
        ...
        for i in range(self.Np + 1):
            ...
            ll_decay = math.exp(-self.ll_decay_rate * i * self.dt)
            ...
            if i < self.Np:
                ...
                ll_decay_next = math.exp(-self.ll_decay_rate * (i + 1) * self.dt)
